...
$config['LicenseName'] = CKF_LicenseName;
$config['LicenseKey'] = CKF_LicenseKey;
...
foreach ($directories as $resource) {  //use the settings from ckf_assets_constants.php
   $resource['url'] = $baseUrl . $resource['base'];
   $resource['directory'] = $baseDir . $resource['base'];
